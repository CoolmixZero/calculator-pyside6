...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tempLabel.setStyleSheet(u"color: #888;")
        self.tempLabel.setAlignment(Qt.AlignRight | Qt.AlignTrailing | Qt.AlignVCenter)

        self.verticalLayout.addWidget(self.tempLabel)

        self.LineEdit_entry = QLineEdit(self.centralwidget)
        self.LineEdit_entry.setObjectName(u"LineEdit_entry")
        sizePolicy1 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Maximum)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.LineEdit_entry.sizePolicy().hasHeightForWidth())
        self.LineEdit_entry.setSizePolicy(sizePolicy1)
        self.LineEdit_entry.setStyleSheet(u"font-size: 40pt;\n"
                                    "                                border: none;\n"
                                    "                            ")
        self.LineEdit_entry.setMaxLength(16)
        self.LineEdit_entry.setAlignment(Qt.AlignRight | Qt.AlignTrailing | Qt.AlignVCenter)
        self.LineEdit_entry.setReadOnly(True)

        self.verticalLayout.addWidget(self.LineEdit_entry)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LineEdit_entry.setText(QCoreApplication.translate("MainWindow", u"0", None))
